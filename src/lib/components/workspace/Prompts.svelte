<script lang="ts">
	...
	const shareHandler = async (prompt) => {
		toast.success($i18n.t('Redirecting you to BLDRCore Community'));

		const url = 'https://BLDRCore.com';
...
<div class=" my-16">
	<div class=" text-lg font-semibold mb-3 line-clamp-1">
		{$i18n.t('Made by BLDRCore Community')}
	</div>

	<a
		class=" flex space-x-4 cursor-pointer w-full mb-2 px-3 py-2"
		href="https://BLDRCore.com/#open-webui-community"
		target="_blank"
	>
